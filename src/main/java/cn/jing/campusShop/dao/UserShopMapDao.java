...
public interface UserShopMapDao {
	...
	/**
	 * function:根据传入的用户Id和shopId查询该用户在某个店铺的积分信息
	 * 
	 * @param userId
	 * @param shopId
	 * @return
	...
	/**
	 * function：配合queryUserShopMapList根据相同的查询条件返回用户店铺积分记录总数
	 * 
	 * @param userShopCondition
	 * @return
	 */
