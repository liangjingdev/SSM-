...
$(function() {
	...
	var pageSize = 3;
	// 列出商品列表的URL
	var listUrl = '/campusShop/frontend/listproductsbyshop';
	// 默认的页码
	var pageNum = 1;
	// 从地址栏里获取ShopId
	...
	var searchDivUrl = '/campusShop/frontend/listshopdetailpageinfo?shopId=' + shopId;
	...
	$('.list-div').on(
		...
		function(e) {
			...
			window.location.href = '/campusShop/frontend/productdetail?productId='
				+ productId;
		});
