$(function() {
	...
	var pageSize = 10;
	//获取该用户的奖品领取记录列表的URL
	var listUrl = '/campusShop/frontend/listuserawardmapsbycustomer';

	var pageNum = 1;
	var awardName = '';
	addItems(pageSize, pageNum);
	//按照查询题哦啊煎获取奖品兑换记录列表，并生成对应的HTML元素添加到页面中
	...
	$('.list-div').on('click', '.card', function(e) {
		...
		window.location.href = '/campusShop/frontend/myawarddetail?userAwardId=' + userAwardId;
	});
